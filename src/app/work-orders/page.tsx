...
import WorkOrdersClient from './ui/WorkOrdersClient';
  ...
  return (
    <div className="bg-[#161b22] border border-[#30363d] rounded-lg p-6">
      ...
      <p className="text-sm text-[#8b949e]">
        Set <code className="text-[#e6edf3]">NEXT_PUBLIC_CONVEX_URL</code> to enable Work Orders.
      </p>
    </div>
  );
}
      ...
      <main className="flex-1 ml-64">
        <div className="max-w-6xl mx-auto px-8 py-12">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-[#e6edf3]">Work Orders</h1>
              <p className="text-[#8b949e]">Mission Control source of truth for delegated implementation work</p>
            </div>
          </div>

          {hasConvex ? <WorkOrdersClient /> : <SetupNotice />}
        </div>
      </main>
    </div>
  );
